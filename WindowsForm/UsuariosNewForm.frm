...
Begin VB.Form UsuariosNewForm 
   ...
   EndProperty
   Icon            =   "UsuariosNewForm.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Picture         =   "UsuariosNewForm.frx":08CA
   ScaleHeight     =   11430
   ScaleWidth      =   9405
   ...
   End
End
Attribute VB_Name = "UsuariosNewForm"
...
If txt_apellido.Text = "" Then MsgBox "Por favor, ingrese su apellido", vbInformation, "Aviso": txt_apellido.SetFocus: Exit Sub
          If IsNumeric(txt_apellido.Text) = True Then MsgBox ("Por favor, no ingrese número en el campo de apellido"), vbInformation, "Aviso": txt_apellido.SetFocus: Exit Sub
...
If txt_cedula.Text = "" Then MsgBox "Por favor ingrese su cédula", vbInformation, "Aviso": txt_cedula.SetFocus: Exit Sub
          ...
          With RsUsuarios
                    ...
                    If .EOF Then
                              'no hago nada
                    Else
                              MsgBox ("Ya existe un usuario registrado con ésta cédula, por favor verifique"), vbInformation, "Aviso": Exit Sub
                    End If
          End With
...
If cbo_Tarea.Text = "" Then MsgBox "Por favor, indique o seleccione una tarea (rol) dentro del almacén", vbInformation, "Aviso": cbo_Tarea.SetFocus: Exit Sub
...
With RsUsuarios
            ...
            Else
                !rango = 1
                         ...
                         With RsLogs
                                   ...
                                   .AddNew
                                             !User = vUsername
                                             !Accion = "creó un usuario a " & txt_nombre & " " & txt_apellido & " (" & txt_username.Text & ") con rango: 1 el"
                                             !Fecha = Date + Time
                                   .Update
                                   .Requery
                                   .Close
    ...
    .Requery
    Limpiar
    MsgBox "Usuario creado con éxito", vbInformation, "Aviso"
Else
